...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x408387f0, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x408387f0, msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x40838158, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x40838158, msg, payload, len);
#line 67
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x40301ce0){
#line 64
  switch (arg_0x40301ce0) {
#line 64
...
#line 64
    default:
#line 64
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x40301ce0);
#line 64
      break;
#line 64
    }
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40a103a8){
#line 72
  switch (arg_0x40a103a8) {
#line 72
    case 0U:
#line 72
      BlinkC$Timer0$fired();
...
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40a103a8);
#line 72
      break;
#line 72
    }
...
static inline void BlinkC$Boot$booted(void )
{
  BlinkC$Timer0$startPeriodic(100);
  BlinkC$Timer1$startPeriodic(500);
  BlinkC$Timer2$startPeriodic(250);
}
